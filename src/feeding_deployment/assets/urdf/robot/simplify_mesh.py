...
def simplify_mesh_with_pybullet(input_mesh_path, output_mesh_path, vhacd_params=None):
    ...
    success = p.vhacd(input_mesh_path, output_mesh_path, "vhacd_log.txt", vhacd_params)
...
# Example usage:
input_mesh = "path/to/your/input_mesh.obj"
output_mesh = "path/to/your/output_simplified_mesh.obj"
